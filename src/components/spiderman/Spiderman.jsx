...
useEffect(()=>{
  let RX = gsap.quickTo(spiderman.scene.rotation,'y', {duration: .5,ease: "sine"});
  window.addEventListener('mousemove',(e)=>{
    RX(e.pageX*.0001 + 3.54) 
  })
},[])
  ...
  <EffectComposer>
     ...
     <HueSaturation hue={3}  saturation={1.4}/>
      ...
      <primitive ref={spiderRef} object={spiderman.scene} rotation={[0,3.54,0]} position={ [0,-7.6,0] } scale={5.5} />
